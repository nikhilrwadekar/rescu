...
const ConfirmDeclineNotificationComponent = ({
    ...
    <View style={styles.RTwo}>
        <View style={styles.button}><Button title={declineButtonText} onPress={onPressDecline} /></View>
        <View style={styles.button}><Button title={confirmButtonText} onPress={onPressConfirm} /></View>
     </View>
